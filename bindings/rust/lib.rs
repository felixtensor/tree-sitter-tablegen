...
//! let language = tree_sitter_tablegen::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading TableGen parser");
...
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_tablegen) };
